-- Tabla de códigos de agente para referidos desde landing page (VERSION PRODUCCION)
...
-- Toma el primer candidato por usuario (ordenado por fecha_de_creacion)
-- CAMBIO: usar fecha_de_creacion en lugar de created_at
WITH first_candidate_per_user AS (
  ...
  ORDER BY u.id, c.fecha_de_creacion ASC
)
